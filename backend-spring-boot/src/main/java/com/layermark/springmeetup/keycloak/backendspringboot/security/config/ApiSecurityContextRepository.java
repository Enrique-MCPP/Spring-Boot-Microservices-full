package com.layermark.springmeetup.keycloak.backendspringboot.security.config;

import com.layermark.springmeetup.keycloak.backendspringboot.security.model.AuthenticatedUser;
...
import com.layermark.springmeetup.keycloak.backendspringboot.security.exception.UnauthorizedException;
...
public class ApiSecurityContextRepository implements SecurityContextRepository {
	...
	private AuthenticatedUser getAuthenticatedUserFromKeycLoakToken(String keycloakJwtToken) {
		...
		Jwt jwtDecoded = null;
		try {
			// TODO - remove following comment to use jwtDecoder bean for decoding the JWT token retreived from keycloak
